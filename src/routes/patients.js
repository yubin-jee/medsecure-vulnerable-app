...
// FIX: SQL Injection (CWE-89) - use parameterized queries with hardcoded column names
// Iterate over a hardcoded whitelist so no user-provided key flows into the query string
