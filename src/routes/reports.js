...
// FIX: Use execFileSync to avoid shell interpretation of user input (CWE-78)
...
// FIX: Use execFile to avoid shell interpretation of user input (CWE-78)
...
// FIX: Use execFileSync with array args to avoid shell interpretation (CWE-78)
